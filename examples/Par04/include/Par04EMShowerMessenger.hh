 ...
 *
 * Allows to set the parameters of the Par04EMShowerModel: parameters of the
...
class Par04EMShowerMessenger : public G4UImessenger {
public:
  Par04EMShowerMessenger(Par04EMShowerModel *aModel);
  ~Par04EMShowerMessenger();
...
private:
  /// Model to setup
  Par04EMShowerModel *fModel;
  /// Command to set the up a directory for model settings /Par04/fastSim
